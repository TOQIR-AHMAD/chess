 ...
 *
 * Two things live here because both pieces of chrome need them and neither owns
 * the other: whether the rail is collapsed to its icon width, and the title the
 * navbar shows for the current page.
 *
...
export function ShellProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<ShellContextValue>(
    () => ({ collapsed, toggleCollapsed, title, setTitle }),
    [collapsed, toggleCollapsed, title],
  );
